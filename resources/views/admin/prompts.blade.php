...
<div class="container-fluid" style="max-width: 900px; margin: 0 auto;">
    ...
    <div class="glass-card p-4">
        ...
        <form action="{{ route('admin.prompts.update') }}" method="POST">
            ...
            <div class="mb-4">
                <label for="prompt_summary" class="form-label fw-semibold text-white">1. AI Notes / Summary Prompt</label>
            ...
            <div class="mb-4">
                <label for="prompt_quiz" class="form-label fw-semibold text-white">2. AI Quiz Generator Prompt</label>
            ...
            <div class="mb-4">
                <label for="prompt_study_planner" class="form-label fw-semibold text-white">3. AI Study Planner Prompt</label>
            ...
            <div class="mb-4">
                <label for="prompt_exam_predictor" class="form-label fw-semibold text-white">4. AI Exam Predictor Prompt</label>
            ...
            <div class="mb-4">
                <label for="prompt_chat_materi" class="form-label fw-semibold text-white">5. AI Chat Materi Prompt</label>
